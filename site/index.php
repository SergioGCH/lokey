              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="detail-box">
                    ...
                    <p>
                      Lokey tiene un modelo bluetooth para conectar a tu smartphone y guardar la ubicación directamente con la potencia de tu dispositivo, y un modelo independiente que puede guardar las ubicaciones sin necesidad de usar constantemente el bluetooth.
                    </p>
                    <div class="btn-box">
                      <a href="" class="btn1">
                        ¡Elige el tuyo!
